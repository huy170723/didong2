...
export default function CarDetailScreen() {
  ...
  const fetchCarDetails = async () => {
    try {
      ...
      const carData = await carService.getCarById(Number(id));
      setCar(carData);
  ...
  const features = [
    ...
    { icon: MapPin, label: 'Màu sắc', value: car.color },
  ];

  const images = car.image_urls || [car.image_url];
  ...
  return (
    <View style={styles.container}>
      <ScrollView>
        ...
        <View style={styles.imageContainer}>
          <Image
            ...
            resizeMode="cover"
            defaultSource={{ uri: 'https://via.placeholder.com/800x600' }}
          />
      ...
      <View style={styles.actionBar}>
        ...
        >
          <Text style={styles.buyButtonText}>Đặt mua ngay</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
